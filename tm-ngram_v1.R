...
red<-seq(1,length(text),by=10000)
text<-text[red]
...
## Estimate word and bigram probs (create ngram model)#######################

M<- matrix(0,nrow=nrow(termFreqTable),ncol=nrow(termFreqTable))

#split bigram into individual words
